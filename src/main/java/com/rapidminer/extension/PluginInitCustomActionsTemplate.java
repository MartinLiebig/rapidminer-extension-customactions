...
import com.rapidminer.repository.RepositoryActionConditionImplExampleSetsOnly;
 ...
 * @author REPLACEME
 */
public final class PluginInitCustomActionsTemplate {

		private PluginInitCustomActionsTemplate() {
		...
		public static void initGui(MainFrame mainframe) {
			RepositoryTree.addRepositoryAction(WriteXLXSRepositoryAction.class,
					new RepositoryActionConditionImplExampleSetsOnly(),
					RenameRepositoryEntryAction.class,
					true,
					false
					);
			RepositoryTree.addRepositoryAction(OpenCustomFileBrowserAction.class,
					new RepositoryActionConditionImplStandard(
							new Class<?>[] { Entry.class }, new Class<?>[] { LocalRepository.class }),
					OpenInFileBrowserAction.class,
					false,
					false
			);
		}
